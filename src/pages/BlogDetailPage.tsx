        ...
        <div className="row">
          <div className="col-xl-8">
            ...
            <div className="blog-details-content">
              <div className="blog-post-item mb-60">
                <div className="post-content" data-aos="fade-up" data-aos-delay={10} data-aos-duration={1000}>
                  ...
                  <div className="post-meta">
                    <span><Link to="#"><i className="far fa-user" />By Admin</Link></span>
                    <span><Link to="#"><i className="far fa-calendar-alt" />12 Apr 2024</Link></span>
                    <span><Link to="#"><i className="far fa-comment" />45 Comments</Link></span>
                  </div>
                  ...
                  <figure><img src="/images/blog-single-1.jpg" alt="Post Thumbnail" /></figure>
                  ...
                  <ul>
                    <li><i className="flaticon-star-3" />Unleash the Potential of Email Marketing</li>
                    <li><i className="flaticon-star-3" />Optimize for Search Engines (SEO)g</li>
                    <li><i className="flaticon-star-3" />Offer Incentives and Discounts</li>
                  </ul>
              ...
              <div className="pesco-comment-area mb-40" data-aos="fade-up" data-aos-delay={30} data-aos-duration={1000}>
                <h4 className="mb-40">Total Reviews (90)</h4>
                <ul>
          ...
          <div className="col-xl-4">
            ...
            <div className="sidebar-widget-area mb-50">
                ...
                <div className="widget-content">
                  <ul className="recent-post-list">
                    <li className="post-thumbnail-content">
                      <img src="/images/post-thumb-1.jpg" alt="post thumb" />
                      <div className="post-title-date">
                        <h6><Link to="/blog-detail">Tips on Finding Affordable Fashion Gems Online</Link></h6>
                        <span className="posted-on"><Link to="#">May 10, 2024</Link></span>
                      </div>
                    </li>
                    <li className="post-thumbnail-content">
                      <img src="/images/post-thumb-2.jpg" alt="post thumb" />
                      <div className="post-title-date">
                        <h6><Link to="/blog-detail">Mastering the Art of Fashion E-commerce Marketing</Link></h6>
                        <span className="posted-on"><Link to="#">June 15, 2024</Link></span>
                      </div>
                    </li>
                    <li className="post-thumbnail-content">
                      <img src="/images/post-thumb-3.jpg" alt="post thumb" />
                      <div className="post-title-date">
                        <h6><Link to="/blog-detail">Must-Have Trends You Can Shop Online Now</Link></h6>
                        <span className="posted-on"><Link to="#">July 24, 2024</Link></span>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              {/*=== Sidebar Widget ===*/}
              <div className="sidebar-newsletter-widget mb-40" data-aos="fade-up" data-aos-delay={100} data-aos-duration={1800}>
