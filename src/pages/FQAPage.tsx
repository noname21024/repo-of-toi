...
const FQAPage = () => {
    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-lg-8">
          <div className="section-title mb-50" data-aos="fade-right" data-aos-delay={20} data-aos-duration={1000}>
  ...
  <section className="faq-contact-section pb-90">
    <div className="faq-contact-wrapper overflow-hidden pt-130 pb-85 white-bg">
      <div className="shape svg-shape1"><img src="/images/bg/faq-top.svg" alt="svg shape" /></div>
      <div className="shape svg-shape2"><img src="/images/bg/faq-bottom.svg" alt="svg shape" /></div>
      <div className="container">
        <div className="row">
